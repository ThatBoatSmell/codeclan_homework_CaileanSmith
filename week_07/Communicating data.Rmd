...
tend to be for leisure, rather than practical reasons, such as cycling to work.
...
```{r, echo=FALSE,fig.cap = "Thanks for reading", out.width = '100%'}
