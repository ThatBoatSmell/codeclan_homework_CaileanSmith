...
This method of filtering presents a potential problem - I potentially haven't identified all the Star Trek books, only the ones that happen to have Star Trek in the title. However, for the purposes of this homework, this will do.
...
```{r}
# The below lines of code are not relevant - just checking that grepl functions the way I think it does, and to see if I can identify any other books missed by my original filter
...
This is in no means a fair or meaningful comparison, but oh well
